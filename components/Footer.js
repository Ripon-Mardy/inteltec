    ...
    <footer>
        <div className='container mx-auto py-8'>
           ...
           <Image src={footerLogo} width={170} height={170} />
            <div className='flex flex-col'>
                <span>Office 902, Mazyad Mall, Office Tower-2, <br /> MBZ City, Abu Dhabi</span>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <Link href={'#'} className='mt-5'><Image src={linkedin} /></Link>
            </div>
           </div>
        ...
        <div className='mt-10 bg-gray-400 py-2 md:py-4'>
            <div className='container mx-auto'>
                <p className='text-sm text-center'>Copyright © 2022 by Inteltec Emirates - Subsidiary of Inteltec Emirates Group. All rights reserved. Designed by <Link href={'#'} className='underline'>Marketing Premiere</Link></p>
            </div>
        </div>
